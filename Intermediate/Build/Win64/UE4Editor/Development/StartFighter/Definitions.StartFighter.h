...
#define UE_PROJECT_NAME StartFighter
#define UE_TARGET_NAME StartFighterEditor
#define UE_MODULE_NAME "StartFighter"
...
#define STARTFIGHTER_API DLLEXPORT
